...
# -------------------------------
# 6. Install papermill + jupyter + ipykernel in py38
# -------------------------------
...
# -------------------------------
# 7. Install papermill + jupyter + ipykernel in py37
# -------------------------------
...
# -------------------------------
# 10. Fix permissions for .sh scripts
# -------------------------------
RUN chmod +x /app/scripts/*.sh

# -------------------------------
# 11. Install flask in py38
# -------------------------------
